...
export IMAGE_URL=${IMAGE_URL-quay.io/jsmid/rhtap-qe-jsmid:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-qe-jsmid/wzlts6rii-dotnet-basic-gitops
